...
const CatalogPage = ({query}: { query: IQueryParams }) => {
    ...
    const [boilerManufacturers, partsManufacturers, filteredBoilerParts, boilerParts] = useUnit([$boilerManufacturers, $partsManufacturers, $filteredBoilerParts, $boilerParts])
    ...
    useEffect(() => {
        loadBoilerParts()
    }, [filteredBoilerParts, isFilterInQuery, loadBoilerParts])
