...
const CatalogFilters = ({
    ...
    const [boilerManufacturers, partsManufacturers] = useUnit([$boilerManufacturers, $partsManufacturers])
    const router = useRouter()

    const updatePriceFromQuery = useCallback((priceFrom: number, priceTo: number) => {
